...
function Chat() {
    _s();
    const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])("http://localhost:3000/api/socket", {
        transports: [
            "websocket",
            "polling"
        ],
...
_s(Chat, "Mp3rhAOBuc5ygrSMper2bYYCr74=");
_c = Chat;
var _c;
